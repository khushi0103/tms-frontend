...
import {
  Tag, Plus, Edit2, X, Search, RotateCcw, Loader2,
  Building2, Calendar, Hash, FileText, CheckCircle, XCircle,
  IndianRupee, AlertCircle, Download, Upload, CreditCard, ChevronDown
} from 'lucide-react';
import {
  useVehicleTollTags,
    ...
    <div className={`flex flex-col h-full ${isTab ? '' : 'p-6 bg-[#f8fafc] flex-1 min-h-0 overflow-hidden relative font-sans text-slate-900'}`}>
      {!isTab && (
        <div className="flex items-center mb-8">
          <div className="w-1/4">
            <h2 className="text-2xl font-bold text-[#172B4D]">Toll Tags</h2>
